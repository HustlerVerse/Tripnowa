  ...
  return (
    <div className="min-h-screen bg-[#0f0f0f] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-8">Add New Place</h1>
        ...
        <div className="bg-[#111] rounded-xl shadow-2xl p-8 border border-gray-800">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Input
              ...
              placeholder="e.g., World Wonders, Romance, Adventure"
              required
            />
            ...
            <Input
              ...
              placeholder="e.g., $500-800 per person for 3 days"
              required
            />
            ...
            <Textarea
              ...
              rows={4}
              placeholder="Book hotels in advance&#10;Carry a map"
            />
